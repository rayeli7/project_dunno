...
import 'package:dunno/presentation/add_card_one_screen/models/add_card_one_model.dart';
...
class AddCardOneBloc extends Bloc<AddCardOneEvent, AddCardOneState> {
  ...
  _changeCheckBox(
    ...
    emit(state.copyWith(savemycarddetai: event.value));
  }
