...
import 'package:dunno/presentation/edit_profile_screen/models/edit_profile_model.dart';
import 'package:dunno/data/models/me/get_me_resp.dart';
import 'dart:async';
  ...
  void _onFetchMeSuccess(
    ...
    emit(
      state.copyWith(
        ...
        nameController: TextEditingController(text: resp.data!.name! ?? ''),
      ),
    );
  }
